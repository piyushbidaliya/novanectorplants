        ...
        <div className='flex justify-between flex-col flex-1'>
            ...
            <div className='w-full border-b-1 py-10 sm:py-20 px-4 sm:px-20'>
                ...
                <div className='flex sm:flex-row flex-col gap-4'>
                    <div className=''>
                        <input type="number" placeholder='+380 XX XXX XX XX' className='border-1 border-[#D2D2D7] p-4 mr-4 w-full'/>
                    </div>
                    <button className='bg-black px-6 py-4 uppercase text-[#FFFFFF] font-[Gilroy] text-[14px] sm:text-[16px] leading-[100%] tracking-[2.5%]'>Book A Call</button>
                </div>
            </div>
            {/* bottom block */}
